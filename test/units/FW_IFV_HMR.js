var Constructor = function()
{
    ...
    this.init = function(unit)
    {
        ...
        variantList = ["FW_IFV","FW_IFV_AT","FW_IFV_AA","FW_IFV_ARTY","FW_IFV_ANTIMINE","FW_IFV_RADAR","FW_IFV_MOVE","FW_IFV_ANCH"];
    ...
    this.actionList = ["ACTION_FIRE", "ACTION_CAPTURE", "ACTION_MISSILE", "ACTION_PLACE_PONTOON"];
}

Constructor.prototype = UNIT;
var FW_IFV_HMR = new Constructor();
