var COREAI =
    ...
    infantryGroup : ["INFANTRY_GROUP",  ["FW_INFANTRY", "FW_AST_INFANTRY", "FW_HVY_INFANTRY", "FW_MOTOR"],
                                        [70,         10,     20,       30],
                                        40, 0, "", 0.5],
    lightTankGroup : ["LIGHT_TANK_GROUP",   ["FW_LTANK", "FW_ARTILLERY", "FW_ASSAULT_GUN", "FW_TANK_DESTROYER", "FW_ACAR", "FW_HALFTRACK"],
                                            [100,           20,          20,                 20,                 20,        10],
                                             50, 1, "", 1.0],
    mediumTankGroup : ["MEDIUM_TANK_GROUP", ["FW_TANK_DESTROYER", "FW_MTANK", "FW_ASSAULT_GUN"],
                                            [30,               70,           10],
                                            20, 2, "", 1.0],
    ...
    mediumAmphibiousGroup : ["MEDIUM_AMPHIBIOUS_GROUP", ["HEAVY_HOVERCRAFT"],
                                                        [100,],
                                                        20, 2, "", 1.0],
    lightAirGroup : ["LIGHT_AIR_GROUP", ["FW_LHELI", "FW_AHELI", "FW_PROP"],
                                        [30,       60,           40],
                                        20, 1, "", 1.0],
    heavyAirGroup : ["HEAVY_AIR_GROUP", ["FW_BOMBER", "FW_ATTACKER", "FW_SEAPLANE"],
                                        [40,       50,              30],
                                        10, 3, "", 1.0],
    ...
    lightNavalGroup : ["LIGHT_NAVAL_GROUP", ["FW_FF"],
                                            [100],
                                            30, 1, "", 0.2],
    mediumNavalGroup : ["MEDIUM_NAVAL_GROUP",   ["FW_DD", "FW_CL", "FW_SS"],
                                                [30,       30,        30],
                                                50, 2, "", 1.0],
    heavyNavalGroup : ["HEAVY_NAVAL_GROUP", ["FW_CA", "FW_BB", "FW_CV"],
                                            [40,              20,           10],
                                            50, 3, "", 1.0],
    infantryTransporter : ["FW_THELI", "FW_TR"],
    infantrySameIslandTransporter : ["FW_TRUCK","FW_HALFTRACK","FW_APC"],
    infantrySearchTransporter : ["FW_THELI", "FW_TR", "FW_TRUCK","FW_HALFTRACK","FW_APC"],
    tankTransporter : ["FW_TR", "FW_TRANSPORT"],
    tankNavalTransporter : ["FW_TR"],
    tankAirTransporter : ["FW_TRANSPORT"],
    antiAirUnits : ["FW_ANTIAIR", "FW_ANTIAIR", "FW_ANTIAIR", "FW_ANTIAIR", "FW_FLAK", "FW_FIGHTER",, "FW_FIGHTER", "FW_FIGHTER", "FW_SAM", "FW_SAM", "FW_FLAK", "FW_CIWS"],
    antiAirSeaUnits : ["FW_CL", "FW_CL", "FW_CA"],
    airUnits : ["FW_LHELI", "FW_AHELI", "FW_PROP", "FW_FIGHTER", "FW_ATTACKER", "FW_SEAPLANE", "FW_BOMBER"],
    stealthAirUnits : ["FW_ATTACKER"],
    antiAirAirUnits : ["FW_FIGHTER", "FW_FIGHTER", "FW_FIGHTER", "FW_FIGHTER", "FW_FIGHTER", "FW_PROP", "FW_ATTACKER", "FW_ATTACKER", "FW_FLAK"],
    heavyAirUnits : ["FW_FIGHTER", "FW_BOMBER", "FW_ATTACKER", "FW_SEAPLANE"],
    lightAirUnits : ["FW_LHELI", "FW_AHELI", "FW_PROP"],
    supplyUnits : ["FW_TRUCK", "FW_TRUCK", "FW_TRUCK", "FW_APC", "FW_APC"],
    antiTankUnits : ["FW_TANK_DESTROYER", "FW_TANK_DESTROYER", "FW_ATGUN", "FW_HTANK"],    
    mediumTankUnits : ["FW_MTANK", "FW_MTANK", "FW_HTANK"],
    antiMediumTankBuildUnits : ["FW_HTANK", "FW_HTANK", "FW_TANK_DESTROYER", "FW_TANK_DESTROYER", "FW_TANK_DESTROYER", "FW_ATTACKER", "FW_ATTACKER", "FW_ATGUN"],
