var COREAI =
    ...
    infantryGroup : ["INFANTRY_GROUP",  ["FW_INFANTRY", "FW_AST_INFANTRY", "FW_HVY_INFANTRY", "FW_MOTOR"],
                                        [70,         10,     20,       30],
                                        40, 0, "", 0.5],
    lightTankGroup : ["LIGHT_TANK_GROUP",   ["FW_LTANK", "FW_ARTILLERY", "FW_ASSAULT_GUN", "FW_TANK_DESTROYER", "FW_ACAR", "FW_HALFTRACK","FW_HALFTRACK_AT"],
                                            [100,           20,          20,                 20,                 20,        10, 20],
                                             50, 1, "", 1.0],
    mediumTankGroup : ["MEDIUM_TANK_GROUP", ["FW_TANK_DESTROYER", "FW_MTANK", "FW_ASSAULT_GUN","FW_MTANK_ANTIMINE"],
                                            [30,               70,           10, 35],
                                            20, 2, "", 1.0],
    heavyTankGroup : ["HEAVY_TANK_GROUP",   ["FW_HTANK", "FW_SHTANK", "FW_ROCKET", "FW_HVY_ARTILLERY"],
                                            [60,          10,          20,         20],
                                            10, 3, "", 1.0],
    ...
    mediumAmphibiousGroup : ["MEDIUM_AMPHIBIOUS_GROUP", ["HEAVY_HOVERCRAFT"],
                                                        [100,],
                                                        20, 2, "", 1.0],
    lightAirGroup : ["LIGHT_AIR_GROUP", ["FW_LHELI", "FW_AHELI", "FW_PROP", "FW_LHELI_RADAR", "FW_LHELI_ASM", "FW_LHELI_AA", "FW_AHELI_TRN", "FW_PROP_AA", "FW_PROP_AA", "FW_PROP_AA"],
                                        [30,       60,           40, 10, 10, 20, 40, 30, 10, 30],
                                        20, 1, "", 1.0],
    heavyAirGroup : ["HEAVY_AIR_GROUP", ["FW_BOMBER", "FW_ATTACKER", "FW_SEAPLANE", "FW_ATTACKER_ASM"],
                                        [40,       50,              30, 10],
                                        10, 3, "", 1.0],

    navalInfantryGroup : ["NAVAL_INFANTRY_GROUP",   ["FW_FF"],
                                                    [100],
                                                    10, 0, "", 0.05],
    lightNavalGroup : ["LIGHT_NAVAL_GROUP", ["FW_FF"],
                                            [100],
                                            30, 1, "", 0.2],
    mediumNavalGroup : ["MEDIUM_NAVAL_GROUP",   ["FW_DD", "FW_CL", "FW_SS", "FW_DD_AA", "FW_DD_ASM"],
                                                [30,       30,        30,        20,        20],
                                                50, 2, "", 1.0],
    heavyNavalGroup : ["HEAVY_NAVAL_GROUP", ["FW_CA", "FW_BB", "FW_CV", "FW_CL_ARTY"],
                                            [40,              20,           10, 30],
                                            50, 3, "", 1.0],
    infantryTransporter : ["FW_THELI", "FW_TR", "FW_THELI_TRN", "FW_AHELI_TRN"],
    infantrySameIslandTransporter : ["FW_TRUCK","FW_HALFTRACK","FW_APC", "FW_HALFTRACK_AA", "FW_HALFTRACK_ARTY", "FW_HALFTRACK_AT", "FW_HALFTRACK_HMR"],
    infantrySearchTransporter : ["FW_THELI", "FW_TR", "FW_THELI_TRN", "FW_AHELI_TRN","FW_TRUCK","FW_HALFTRACK","FW_APC", "FW_HALFTRACK_AA", "FW_HALFTRACK_ARTY", "FW_HALFTRACK_AT", "FW_HALFTRACK_HMR"],
    tankTransporter : ["FW_TR", "FW_TRANSPORT"],
    tankNavalTransporter : ["FW_TR"],
    tankAirTransporter : ["FW_TRANSPORT"],
    antiAirUnits : ["FW_ANTIAIR", "FW_ANTIAIR", "FW_ANTIAIR", "FW_ANTIAIR", "FW_FLAK", "FW_FIGHTER",, "FW_FIGHTER", "FW_FIGHTER", "FW_SAM", "FW_SAM", "FW_FLAK", "FW_CIWS", "FW_ATTACKER_AA", "FW_FIGHTER_GUN", "FW_FIGHTER_FUEL", "FW_FLAK_AA", "FW_HALFTRACK_AA", "FW_HVY_INFANTRY_AA", "FW_SAM_MOVE", "FW_SAM_UPGRD", "FW_SEAPLANE_AA"],
    antiAirSeaUnits : ["FW_CL", "FW_CL", "FW_CA", "FW_DD_AA"],
    airUnits : ["FW_LHELI", "FW_AHELI", "FW_PROP", "FW_FIGHTER", "FW_ATTACKER", "FW_SEAPLANE", "FW_BOMBER", "FW_ATTACKER_AA", "FW_BOMBER_ARTY", "FW_FIGHTER_BOMB", "FW_FIGHTER_FUEL", "FW_FIGHTER_GUN", "FW_LHELI_AA", "FW_LHELI_ASM", "FW_LHELI_RADAR", "FW_PROP_AA", "FW_PROP_AT", "FW_SEAPLANE_AA", "FW_TRANSPORT_BOMB"],
    stealthAirUnits : ["FW_ATTACKER"],
    antiAirAirUnits : ["FW_FIGHTER", "FW_FIGHTER", "FW_FIGHTER", "FW_FIGHTER", "FW_FIGHTER", "FW_FIGHTER_GUN", "FW_FIGHTER_GUN", "FW_FIGHTER_FUEL", "FW_FIGHTER_FUEL", "FW_ATTACKER_AA", "FW_ATTACKER_AA", "FW_FIGHTER_GUN", "FW_SEAPLANE_AA", "FW_SEAPLANE_AA", "FW_PROP", "FW_ATTACKER", "FW_ATTACKER", "FW_FLAK"],
    heavyAirUnits : ["FW_FIGHTER", "FW_BOMBER", "FW_ATTACKER", "FW_SEAPLANE", "FW_FIGHTER_GUN", "FW_FIGHTER_FUEL", "FW_ATTACKER_AA", "FW_SEAPLANE_AA"],
    lightAirUnits : ["FW_LHELI", "FW_AHELI", "FW_PROP", "FW_LHELI_AA", "FW_LHELI_RADAR", "FW_PROP_AA", "FW_PROP_AT", "FW_PROP_ASM"],
    supplyUnits : ["FW_TRUCK", "FW_TRUCK", "FW_TRUCK", "FW_APC", "FW_APC", "FW_THELI_FUEL", "FW_AX", "FW_TRANSPORT_FUEL"],
    antiTankUnits : ["FW_TANK_DESTROYER", "FW_TANK_DESTROYER", "FW_ATGUN", "FW_HTANK", "FW_PROP_AT", "FW_HALFTRACK_AT"],    
    mediumTankUnits : ["FW_MTANK", "FW_MTANK", "FW_HTANK"],
    antiMediumTankBuildUnits : ["FW_HTANK", "FW_HTANK", "FW_TANK_DESTROYER", "FW_TANK_DESTROYER", "FW_TANK_DESTROYER", "FW_ATTACKER", "FW_ATTACKER", "FW_ATGUN", "FW_PROP_AT", "FW_PROP_AT"],
    reconUnits : ["FW_RECON", "FW_RECON", "FW_RECON", "FW_ACAR", "FW_ACAR", "FW_LTANK"],
    antiReconUnits : ["FW_LTANK", "FW_LTANK", "FW_LTANK", "FW_MTANK", "FW_MTANK", "FW_TANK_DESTROYER", "FW_LHELI", "FW_AHELI", "FW_AHELI", "FW_ACAR", "FW_ATTACKER", "FW_PROP", "FW_BOMBER", "FW_SEAPLANE"],
    heavyTankUnits : ["FW_HTANK", "FW_SHTANK"],
    bomberUnits : ["FW_BOMBER","FW_ATTACKER"],
    groundScoutUnits : ["FW_RECON", "FW_ACAR"],
    antiSubmarineUnits : ["FW_DD"],
    submarineUnits : ["FW_SS"],
    antiHeavyNavalUnits : ["FW_SS"],
    productionBuildings : ["FACTORY", "AIRPORT", "HARBOUR"],
    ...
    {
        COREAI.addModifiedDistribution(system, ai, co1, co2, directIndirectRatio, COREAI.lightAirGroup, "FW_AHELI", groupDistribution[1] * player.getCoGroupModifier(COREAI.lightAirGroup[1], system));
        COREAI.addModifiedDistribution(system, ai, co1, co2, directIndirectRatio, COREAI.heavyAirGroup, "FW_BOMBER", groupDistribution[3] * player.getCoGroupModifier(COREAI.heavyAirGroup[1], system));
    },

    initNavalForceDistribution : function(system, ai, player, co1, co2, directIndirectRatio, groupDistribution)
    {
        COREAI.addModifiedDistribution(system, ai, co1, co2, directIndirectRatio, COREAI.navalInfantryGroup, "FW_FF", groupDistribution[0] * player.getCoGroupModifier(COREAI.navalInfantryGroup[1], system));
        COREAI.addModifiedDistribution(system, ai, co1, co2, directIndirectRatio, COREAI.lightNavalGroup, "FW_DD", groupDistribution[1] * player.getCoGroupModifier(COREAI.lightNavalGroup[1], system));
        COREAI.addModifiedDistribution(system, ai, co1, co2, directIndirectRatio, COREAI.mediumNavalGroup, "FW_CL", groupDistribution[2] * player.getCoGroupModifier(COREAI.mediumNavalGroup[1], system));
        COREAI.addModifiedDistribution(system, ai, co1, co2, directIndirectRatio, COREAI.heavyNavalGroup, "FW_CA", groupDistribution[3] * player.getCoGroupModifier(COREAI.heavyNavalGroup[1], system));
    },
    ...
    buildUnitSimpleProductionSystem : function(system, ai, buildings, units, enemyUnits, enemyBuildings, map)
    {
        ...
        if (productionCount > 0)
        {
            maxBaseCost = funds - productionCount * COREAI.reservedFundsPerFactory;
        }
        else
        {
            maxBaseCost = funds;
        }
        if (maxBaseCost < COREAI.reservedFundsPerFactory)
        {
            maxBaseCost = COREAI.reservedFundsPerFactory;
        }

        if (turnProducedUnits > COREAI.maxSpamingUnits)
        {
