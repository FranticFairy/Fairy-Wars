var Constructor = function()
{
    ...
    {
        return qsTr("Light mist, not nearly enough to cause a problem, but can lead to denser mist.");
    };

    this.getWeatherSymbol = function()
    {
        return "weather_symbol_mist_alt";
    };
...
var WEATHER_MISTY = new Constructor();
