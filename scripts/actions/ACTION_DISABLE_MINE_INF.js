var Constructor = function()
{
    ...
    this.canBePerformed = function(action, map)
    {
        ...
        if (ACTION.isEmptyFieldAndHasNotMoved(action, unit, actionTargetField, targetField, map) &&
            ACTION_DISABLE_MINE_INF.getDisableFields(action, map).length > 0)
        {
            return true;
        }
        return false;
    ...
    this.getStepData = function(action, data, map)
    {
        ...
        var fields = ACTION_DISABLE_MINE_INF.getDisableFields(action, map);
    ...
    this.perform = function(action, map)
    {
        ...
        animation.setEndOfAnimationCall("ACTION_DISABLE_MINE_INF", "performPostAnimation");
        ...
        action.startReading();
        // read action data
        ACTION_DISABLE_MINE_INF.postAnimationTargetX = action.readDataInt32();
        ACTION_DISABLE_MINE_INF.postAnimationTargetY = action.readDataInt32();
    };
    this.performPostAnimation = function(postAnimation, map)
    {
        var terrain = map.getTerrain(ACTION_DISABLE_MINE_INF.postAnimationTargetX, ACTION_DISABLE_MINE_INF.postAnimationTargetY);
        ...
        ACTION_DISABLE_MINE_INF.postAnimationTargetX = -1;
        ACTION_DISABLE_MINE_INF.postAnimationTargetY = -1;
    };
...
var ACTION_DISABLE_MINE_INF = new Constructor();
